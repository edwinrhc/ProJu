...
public interface IMovimientoDao extends JpaRepository<Movimiento,Long> {
    ...
    @Query("SELECT new com.stfonavi.proju.dto.MovimientoDetailDTO(m.idMovimiento,m.nombre, m.idEtapaProcesal, m.idContigencia, m.createdAt, m.createdBy, m.updatedAt, m.updatedBy) " +
