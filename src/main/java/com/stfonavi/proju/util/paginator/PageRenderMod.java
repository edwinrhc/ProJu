...
public class PageRenderMod<T> {
    ...
    private final String nombrePaginas; // Nuevo atributo para almacenar el parámetro de búsqueda

	public PageRenderMod(String url, Page<T> page, String nombrePaginas) {
		this.url = url;
		this.page = page;
        ...
        this.nombrePaginas = nombrePaginas; // Asignar el valor del parámetro nombre al atributo
    ...
    public String getUrlPage(int numPage) {
        return url + "?nombre=" + nombrePaginas + "&page=" + numPage;
    }
}
